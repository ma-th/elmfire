...
SIMULATION_TSTOP=43200.0 # Simulation stop time (seconds)
...
for WIND_SPEED in 15.0; do #$(seq 0 1 30); do
   ...
   #gdb --args 
   /home/dwip/binYiren_SU2/elmfire_$ELMFIRE_VER ./inputs/elmfire.data
...
if [ -d "outputsSingle" ]; then
   rm -r outputsSingle
fi

mkdir outputsSingle
mv outputs_C* outputsSingle
